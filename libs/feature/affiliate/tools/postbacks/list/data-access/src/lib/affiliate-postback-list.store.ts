...
export interface AffiliatePostbackListState extends BaseEntityState<AffiliatePostbackListModel> {
    data?: {
...
const initialAffiliatePostbackListState = (): any =>
    createEntityInitialState<AffiliatePostbackListState>({
        data: {
...
export class AffiliatePostbackListStore extends BaseEntityStore<AffiliatePostbackListState> {
    constructor() {
        super(initialAffiliatePostbackListState());
    }
}
