...
@Component({
    selector: 'scaleo-affiliate-report-conversions',
    templateUrl: './affiliate-report-conversions.component.html',
    ...
    providers: [
        ...
        UnsubscribeService,
        {
            ...
            useValue: {
                name: 'affiliate-report-conversions'
            }
        },
        {
...
export class AffiliateReportConversionsComponent extends BaseTransactionReportComponent implements OnInit, OnDestroy, AfterViewInit {
