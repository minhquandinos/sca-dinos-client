...
@Component({
    selector: 'scaleo-affiliate-statistics-navigation',
    templateUrl: './affiliate-access-statistics-navigation.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class AffiliateAccessStatisticsNavigationComponent {
