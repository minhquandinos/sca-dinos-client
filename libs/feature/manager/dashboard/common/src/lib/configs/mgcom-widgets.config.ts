...
export const mgcomWidgetsConfig: DashboardWidgetModel[] = [
    {
        id: DASHBOARD_WIDGET.mgcomTop,
        identifier: DASHBOARD_WIDGET.mgcomTop,
        active: true,
        multi: false,
        gridConfig: {
            cols: GridConfigColEnum.Full,
            rows: GridConfigRowEnum.Three,
            minItemCols: GridConfigColEnum.Full,
            minItemRows: GridConfigRowEnum.Two,
            maxItemRows: GridConfigRowEnum.Three,
            y: 0,
            x: 0,
            resizeEnabled: false
        }
