...
import { ManagerOfferListComponent } from './manager-offer-list.component';

@NgModule({
    declarations: [ManagerOfferListComponent],
    imports: [
        CommonModule,
        UiSkeletonModule,
        UiStatusColorModule,
    ...
    exports: [ManagerOfferListComponent]
})
export class ManagerOfferListModule {}
