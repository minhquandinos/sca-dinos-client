...
import { AffiliateSignupModel, SettingsAffiliateSignupService } from '@scaleo/feature/manager/data-access/settings/affiliates';
...
@Component({
    selector: 'scaleo-mng-settings-affiliate-signup',
...
export class AffiliateSignupComponent implements OnInit {
    ...
    public formData: AffiliateSignupModel;
    ...
    // private parentComponent: AffiliatesComponent;
    ...
    constructor(
        ...
        private readonly service: SettingsAffiliateSignupService
    ) {
    ...
    private initForm(): void {
        this.form = this.formBuilder.group({
            ...
            api_enabled_by_default: BooleanEnum.False,
    ...
    private loadFormData(): void {
        this.service
            ...
            .subscribe((fields: FieldsInterface) => {
                this.fields = fields;
                this.standartFields = fields['standard-fields'].filter((field) => field.id !== 24 && field.id !== 25);
