...
import { ReportAdvertiserPostbacksComponent } from './components/report-advertiser-postbacks/report-advertiser-postbacks.component';

@NgModule({
    declarations: [ReportAdvertiserPostbacksComponent],
    imports: [
        CommonModule,
        UiPageWrapperModule,
        ResultCountModule,
