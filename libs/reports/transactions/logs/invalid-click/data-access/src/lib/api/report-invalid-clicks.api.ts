...
@Injectable()
export class ReportInvalidClicksApi extends BaseReportLogsApi {
    constructor(protected rest: RestApiService) {
        super(rest, ReportPagesEnum.InvalidClicks);
    }
    ...
    exportData(filters?: Filter2Interface): Observable<any> {
        ...
        return this.rest.post('reports-invalid-clicks-log-export', payload, options);
    }
}
