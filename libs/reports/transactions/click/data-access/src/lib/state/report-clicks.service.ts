...
import { ReportClickApi } from '../api/report-click.api';
import { ReportClicksQuery } from './report-clicks.query';
import { ReportClicksStore } from './report-clicks.store';

@Injectable()
export class ReportClicksService
    extends BaseReportService<ReportClicksStore, ReportClicksQuery, ReportClickApi>
    implements BaseReportInterface, BaseTransactionListReportServiceInterface
{
    constructor(
        protected api: ReportClickApi,
        protected store: ReportClicksStore,
        private translate: TranslateService,
        protected query: ReportClicksQuery,
