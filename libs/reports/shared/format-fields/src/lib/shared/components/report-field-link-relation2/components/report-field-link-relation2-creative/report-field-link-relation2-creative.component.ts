...
@Component({
    selector: 'app-report-field-link-relation2-creative',
    templateUrl: './report-field-link-relation2-creative.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [FormatPipe]
})
export class ReportFieldLinkRelation2CreativeComponent extends BaseReportFieldLinkRelation2Component implements OnInit {
    linkLabel$ = this.setLabel('table.column.creative');
