...
@Component({
    selector: 'app-report-field-cv-pending',
    templateUrl: './report-field-link-report.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ReportFieldCvPendingComponent extends BaseReportConversionsFieldsLinkReportComponent {
    ...
    get conversionStatusValues(): number[] {
        return [CONVERSION_STATUSES_ID.pending];
    }
}
