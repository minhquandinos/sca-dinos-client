...
@Component({
    selector: 'app-report-field-link-relation2-link',
    templateUrl: './report-field-link-relation2-link.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [FormatPipe]
})
export class ReportFieldLinkRelation2LinkComponent extends BaseReportFieldLinkRelation2Component implements OnInit {
    linkLabel$ = this.setLabel('table.column.link');
