...
import { FindDeviceBrandsService } from './find-device-brands.service';

@DynamicComponentLookup('FindDeviceBrandsComponent')
@Component({
    selector: 'app-find-device-brands',
    template: `
        <app-select
            [items]="items$ | async"
            [loading]="loading"
        ...
        ></app-select>
    `,
    providers: [FindDeviceBrandsService],
    viewProviders: [
        {
...
export class FindDeviceBrandsComponent extends BaseFind4Component<ShortResponseInterface> implements OnInit, AfterViewInit {
    ...
    constructor(protected translate: TranslateService, protected parentF: FormGroupDirective, protected service: FindDeviceBrandsService) {
