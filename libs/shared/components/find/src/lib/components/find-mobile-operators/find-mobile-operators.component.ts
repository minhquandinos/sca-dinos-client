...
import { FindMobileOperatorsService } from './find-mobile-operators.service';

@DynamicComponentLookup('FindMobileOperatorsComponent')
@Component({
    selector: 'app-find-mobile-operators',
    template: `
        <app-select
            [items]="items$ | async"
            [loading]="loading"
        ...
        ></app-select>
    `,
    providers: [FindMobileOperatorsService],
    viewProviders: [
        {
...
export class FindMobileOperatorsComponent extends BaseFind4Component<ShortResponseInterface> implements OnInit, AfterViewInit {
    ...
    constructor(
        ...
        protected service: FindMobileOperatorsService
    ) {
